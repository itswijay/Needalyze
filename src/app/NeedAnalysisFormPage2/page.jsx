  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex justify-center pt-6 pb-10">
        <FormContainer className="max-w-6xl">
          <div className="grid grid-cols-2 gap-12">
            
            {/* Insurance Need Section */}
            <div className="bg-white rounded-3xl p-8 relative shadow-xl border border-gray-100">
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-xl font-semibold text-gray-800 font-sans">Insurance Need</h2>
                <div className="w-6 h-6 rounded-full flex items-center justify-center" style={{backgroundColor: '#89acd0'}}>
            ...
            <div className="bg-white rounded-3xl p-8 relative shadow-xl border border-gray-100">
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-xl font-semibold text-gray-800 font-sans">Health Covers</h2>
                <div className="w-6 h-6 rounded-full flex items-center justify-center" style={{backgroundColor: '#89acd0'}}>
                  <span className="text-white text-sm font-bold font-sans">i</span>
                </div>
              </div>
          ...
          <div className="flex justify-between mt-12">
            <button
              onClick={handleBack}
              className="px-6 py-3 rounded-full text-white font-medium font-sans shadow-md hover:shadow-lg transition 
...
function CheckboxCard({ label, checked, onChange }) {
  return (
    <div 
      className="flex items-center p-4 bg-white rounded-full shadow-2xl border border-gray-200 cursor-pointer hover:shadow-2xl hover:scale-105 transition-all duration-300"
      onClick={onChange}
      style={{
        boxShadow: '0 10px 25px rgba(0, 0, 0, 0.1), 0 4px 10px rgba(0, 0, 0, 0.05)'
      }}
    >
      <div className={`w-7 h-7 rounded-md border-2 mr-4 flex items-center justify-center transition-colors ${
        checked 
          ? 'border-2' 
          : 'border-2'
      }`}
      ...
      <span className="text-gray-700 font-medium text-lg font-sans">{label}</span>
    </div>
  );
}